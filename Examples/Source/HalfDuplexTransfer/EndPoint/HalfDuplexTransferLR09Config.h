#ifndef HALF_DUPLEX_TRANSFER_LR09_CONFIG_H
#define HALF_DUPLEX_TRANSFER_LR09_CONFIG_H
/**
 *  ----------------------------------------------------------------------------
 ...
 *  ----------------------------------------------------------------------------
 *
 *  HalfDuplexTransferLR09Config.h - provides End Point node configuration details 
 *  for the protocol.
 *
 *  @version    1.0.00
 *  @date       16 Jan 2013
...
#define PROTOCOL_USE_RX_TIMEOUT								  // Node uses two-way communication
...
#endif  /* HALF_DUPLEX_TRANSFER_LR09_CONFIG_H */
